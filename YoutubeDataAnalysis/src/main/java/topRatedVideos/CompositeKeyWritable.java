...
public class CompositeKeyWritable implements WritableComparable<CompositeKeyWritable> {
    ...
    public CompositeKeyWritable(String stationName, float count) {
	...
	public void write(DataOutput out) throws IOException {
        ...
        WritableUtils.writeString(out, Float.toString(count));
...
/*
		...
		count =Float.parseFloat(WritableUtils.readString(in));
